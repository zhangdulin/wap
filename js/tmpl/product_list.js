$(function(){
 ...
 $('.changecss2').each(function(){
	if($($(this))[0].href==String(window.location)){
   		$(".changecss2").css("color","#000");
   		$(".changecss2").css("border-bottom","1px solid #000");
   }
});
 
 $('.changecss6').each(function(){
	if($($(this))[0].href==String(window.location)){
   		$(".changecss6").css("color","#000");
   		$(".changecss6").css("border-bottom","1px solid #000");
   }
});
 
  $('.changecss7').each(function(){
	if($($(this))[0].href==String(window.location)){
   		$(".changecss7").css("color","#000");
   		$(".changecss7").css("border-bottom","1px solid #000");
   }
});
  
   $('.changecss4').each(function(){
	if($($(this))[0].href==String(window.location)){
   		$(".changecss4").css("color","#000");
   		$(".changecss4").css("border-bottom","1px solid #000");
   }
});
   
    $('.changecss5').each(function(){
	if($($(this))[0].href==String(window.location)){
   		$(".changecss5").css("color","#000");
   		$(".changecss5").css("border-bottom","1px solid #000");
   }
});
