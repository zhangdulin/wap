$(function (){
    ...
    //     +'</div>'
    // +'</div>';
    var tmpl = '<div style="height:50px;display:block"></div><div class="main-opera-pannel" style="display: block; position:fixed;bottom:0; width:100%; z-index:8888">'
                    + '<div class="main-op-table main-op-warp">'
                        + ' <a href="'+SiteUrl+'/wap/index.html" class="quarter"><span class="i-home"></span><p>首页</p></a>'
                        + ' <a href="'+SiteUrl+'/wap/special.html?special_id=38" class="quarter"><span class="i-categroy"></span style=""><p>发现</p></a>'
                        + '<a href="http://www.viptry.cn/wap/tmpl/cart_list.html" class="quarter"><span class="i-cart"></span><p>&nbsp;购物车</p></a>'
