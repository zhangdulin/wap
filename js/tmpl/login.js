                ...
                success: function (result) {
                    if (!result.datas.error) {
                        if (typeof (result.datas.key) == 'undefined') {
                            ...
                            addcookie('username', result.datas.username,'8640');
                            addcookie('key', result.datas.key,'24');
                            location.href = WapSiteUrl+'/tmpl/member/member.html?act=member&token='+result.datas.key;
                        }
                        $(".error-tips").hide();
                    } else {
